...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "VideoChat@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "VideoChat API";

        private String description = "VideoChat API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "VideoChat";
